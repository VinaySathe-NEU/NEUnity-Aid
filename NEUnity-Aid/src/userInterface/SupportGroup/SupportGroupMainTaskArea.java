 ...
 * @author RakshitaJ
 */
public class SupportGroupMainTaskArea extends javax.swing.JPanel {
    ...
    public SupportGroupMainTaskArea(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise, Ecosystem business, NGODirectory ngoDirectory) {
        initComponents();
    ...
    private void initComponents() {
        ...
        Adoption.setBackground(new java.awt.Color(51, 102, 153));
        ...
        Ado.setForeground(new java.awt.Color(255, 255, 255));
    ...
    private void espousalRequest() {
        NGORequestJPanel panel = new NGORequestJPanel(rightSystemAdminPanel, account, supportGroupOrganization, enterprise, business, ngoDirectory);
