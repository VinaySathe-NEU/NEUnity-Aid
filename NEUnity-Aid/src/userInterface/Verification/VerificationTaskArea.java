 ...
 * @author vinaysathe
 */
public class VerificationTaskArea extends javax.swing.JPanel {
    ...
    public VerificationTaskArea(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise, Ecosystem business, NGODirectory ngoDirectory) {
        initComponents();
    ...
    private void VerificationRequestJPanel(){
        VerificationCheckRequest panel = new VerificationCheckRequest(rightSystemAdminPanel, account, BackgroundAndCriminalCheckOrganization, enterprise, business, ngoDirectory);
    ...
    private void initComponents() {
        ...
        jPanel3.setBackground(new java.awt.Color(47, 72, 88));
        jPanel3.setMinimumSize(new java.awt.Dimension(280, 148));
        jPanel3.setPreferredSize(new java.awt.Dimension(280, 148));
        jPanel3.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        bgcAndCriminal.setBackground(new java.awt.Color(47, 72, 88));
        bgcAndCriminal.setForeground(new java.awt.Color(255, 255, 255));
        ...
        BGCAndCri.setForeground(new java.awt.Color(255, 255, 255));
