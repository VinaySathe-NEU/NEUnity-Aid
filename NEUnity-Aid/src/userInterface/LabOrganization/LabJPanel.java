...
public class LabJPanel extends javax.swing.JPanel {
    ...
    private void btnAssignToMeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAssignToMeActionPerformed
        ...
        TaskRequest request = (TaskRequest) tblLab.getValueAt(selectedRow, 5);
    ...
    private void btnProcessActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProcessActionPerformed
        ...
        LabAssistanceTaskRequest request = (LabAssistanceTaskRequest) tblLab.getValueAt(selectedRow, 5);
        //if (request.getStatus().equalsIgnoreCase("Completed")) {
            if ("Completed".equalsIgnoreCase(request.getStatus())) {
                JOptionPane.showMessageDialog(null, "Request already completed.");
                return;
        ...
        model.setRowCount(0);
        for (TaskRequest request : labOrganization.getTaskQueue().getTaskRequestList()) {
