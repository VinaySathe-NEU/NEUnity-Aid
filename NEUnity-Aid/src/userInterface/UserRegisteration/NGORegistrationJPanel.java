...
import Business.Utilities.ValidationHelper;
...
public class NGORegistrationJPanel extends javax.swing.JPanel {
     ...
     */
    public NGORegistrationJPanel(JPanel userProcessContainer, Ecosystem system) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("NGO Representative Registration");
        ...
        add(AnnualIncomeValidate, new org.netbeans.lib.awtextra.AbsoluteConstraints(1220, 540, -1, -1));
        ...
        add(ssnValidate, new org.netbeans.lib.awtextra.AbsoluteConstraints(1220, 460, -1, -1));
    ...
    private void btnRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegisterActionPerformed
        ...
        if (txtName.getText().isEmpty() || txtUserName.getText().isEmpty() || txtPwd.getText().isEmpty() || txtEmail.getText().isEmpty()
            ...
            NGORegistrationRequest ngoRegistrationRequest = new NGORegistrationRequest();
            String gender = "";
            ...
            ngoRegistrationRequest.setName(txtName.getText());
            ngoRegistrationRequest.setUserName(txtUserName.getText());
            ngoRegistrationRequest.setUserPassword(txtPwd.getText());
            ngoRegistrationRequest.setUserEmailId(txtEmail.getText());
            ngoRegistrationRequest.setGender(gender);
            ngoRegistrationRequest.setNetwork(network);
            ngoRegistrationRequest.setSsn(txtSSN.getText());
            ngoRegistrationRequest.setAddress1(txtAdd1.getText());
            ngoRegistrationRequest.setAddress2(txtAdd2.getText());
            ngoRegistrationRequest.setUserContact(txtContact.getText());
            ngoRegistrationRequest.setStatus("Request access");
            ngoRegistrationRequest.setAnnualIncome(txtIncome.getText());
            ngoRegistrationRequest.setAge(txtAge.getText());
            ...
            try {
                MailSender.sendEmailMessage(txtEmail.getText(), subject, content);
            } catch (UnsupportedEncodingException ex) {
                Logger.getLogger(NGORegistrationJPanel.class.getName()).log(Level.SEVERE, null, ex);
            }
            for (Network network1 : system.getNetworkCatalog()) {
                for (Enterprise enterprise : network1.getEnterpriseDirectory().getEnterpriseList()) {
                    if (enterprise.getEnterpriseType() == Enterprise.EnterpriseType.NGO) {
                        if (enterprise.getTaskQueue() == null) {
                            enterprise.setTaskQueue(new TaskQueue());
                        }
                        enterprise.getTaskQueue().getTaskRequestList().add(ngoRegistrationRequest);
                    }
                }
            }
    ...
    private javax.swing.JComboBox<Business.Network.Network> cmbCity;
