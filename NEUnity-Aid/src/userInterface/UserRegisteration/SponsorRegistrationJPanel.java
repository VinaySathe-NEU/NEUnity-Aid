...
public class SponsorRegistrationJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Sponsor Someone");
        ...
        lblStreet2.setForeground(new java.awt.Color(255, 255, 255));
        ...
        lblStreet1.setForeground(new java.awt.Color(255, 255, 255));
        ...
        lblAnnual.setForeground(new java.awt.Color(255, 255, 255));
            ...
            for (Network network1 : system.getNetworkCatalog()) {
                for (Enterprise enterprise : network1.getEnterpriseDirectory().getEnterpriseList()) {
                    if (enterprise.getEnterpriseType() == Enterprise.EnterpriseType.Funding) {
                        ...
                        enterprise.getTaskQueue().getTaskRequestList().add(registrationRequest);
                    }
                }
            }
