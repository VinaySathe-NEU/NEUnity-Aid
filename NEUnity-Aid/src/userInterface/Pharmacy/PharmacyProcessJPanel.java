...
public class PharmacyProcessJPanel extends javax.swing.JPanel {
    ...
    PharmacistAssistTaskRequest request;
    private PersonDirectory personDirectory;
    private Person person;
    Network network;
    
    public PharmacyProcessJPanel(JPanel userProcessContainer, PharmacistAssistTaskRequest request, UserAccount userAccount, Enterprise enterprise, Person person, PersonDirectory personDirectory, Ecosystem business, PharmacistOrganization pharmacyOrganization) {
        initComponents();
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if (txtComments.getText().isEmpty()) {
            ...
            PersonCareTaskRequest temp = new PersonCareTaskRequest();
            ...
            if (org != null) {
                org.getTaskQueue().getTaskRequestList().add(temp);
                userAccount.getTaskQueue().getTaskRequestList().add(temp);
                business.getTaskQueue().getTaskRequestList().add(temp);
            }
        }
