...
public class PharmacyJPanel extends javax.swing.JPanel {
    ...
    private void btnAssignToMeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAssignToMeActionPerformed
        ...
        TaskRequest request = (TaskRequest) tblPharmacist.getValueAt(selectedRow, 0);
    ...
    private void btnProcessActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProcessActionPerformed
        ...
        PharmacistAssistTaskRequest request = (PharmacistAssistTaskRequest) tblPharmacist.getValueAt(selectedRow, 0);
            if ("Delivered".equalsIgnoreCase(request.getStatus())) {
                JOptionPane.showMessageDialog(null, "Request already completed.");
                return;
            } else {
            ...
            PharmacyProcessJPanel processTaskRequestJPanel = new PharmacyProcessJPanel(userProcessContainer, request, userAccount, enterprise, person, personDirectory, business, pharmacyOrganization);
            userProcessContainer.add("processWorkRequestJPanel", processTaskRequestJPanel);
    ...
    public void populateTable() {
        ...
        model.setRowCount(0);
        for (TaskRequest request : pharmacyOrganization.getTaskQueue().getTaskRequestList()) {
            if(request instanceof PharmacistAssistTaskRequest){
            PharmacistAssistTaskRequest pharrequest =(PharmacistAssistTaskRequest)request;
