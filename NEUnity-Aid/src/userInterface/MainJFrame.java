...
import Business.DatabaseUtility.DatabaseManager;
import Business.Enterprise.Enterprise;
import static Business.InitialiseABusiness.configureEcosystem;
...
import userInterface.UserRegisteration.*;
...
public class MainJFrame extends javax.swing.JFrame {
    ...
    public MainJFrame() {
        ...
        ngoDirectory = ecosystem.getNGODirectory();
        personDirectory = ecosystem.getPersonDirectory();
        donorDirectory = ecosystem.getDonorDirectory();
    }
    ...
    private void initComponents() {
        ...
        btnLogoutLabel.setFont(new java.awt.Font("Helvetica Neueu", 1, 13));
        btnLogoutLabel.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        btnLogoutLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/66847.png"))); // NOI18N
        btnLogoutLabel.setMaximumSize(new java.awt.Dimension(20, 20));
        btnLogoutLabel.setMinimumSize(new java.awt.Dimension(20, 20));
        ...
        lblLogin.setFont(new java.awt.Font("Helvetica Neue", 1, 14)); // NOI18N
        ...
        lblAdopt.setBackground(new java.awt.Color(0, 0, 0));
        lblAdopt.setFont(new java.awt.Font("Helvetica Neue", 1, 14)); // NOI18N
        lblAdopt.setForeground(new java.awt.Color(255, 255, 255));
        lblAdopt.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblAdopt.setText("NGO Registration");
        lblAdopt.setBorder(javax.swing.BorderFactory.createMatteBorder(2, 2, 2, 2, new java.awt.Color(71, 52, 58)));
        lblAdopt.setOpaque(true);
        ...
        lblSponsor.setBackground(new java.awt.Color(0, 0, 0));
        lblSponsor.setFont(new java.awt.Font("Helvetica Neue", 1, 14)); // NOI18N
        ...
        jTextPane1.setFont(new java.awt.Font("Helvetica Neue", 1, 16)); // NOI18N
        jTextPane1.setText("Currently, NEUnity-AID can help provide relief in terms of Medical Help, Educational Help, Emergency Rescue Services and Financial Aid. We believe, help provided is help received.");
        ...
        jTextPane3.setFont(new java.awt.Font("Helvetica Neue", 1, 16)); // NOI18N
        jTextPane3.setText("With NEUnity-Aid, we want to remind you that you are not alone. Northeastern University, with it's Alumni and Extensive Network can help you in any calamitous situation.");
        ...
        loginJPanel.add(lblCancel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1250, 10, 40, 40));

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));

        jLabel4.setBackground(new java.awt.Color(255, 255, 255));
        jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Sun.png"))); // NOI18N
        jLabel4.setMaximumSize(new java.awt.Dimension(10, 8));
        jLabel4.setMinimumSize(new java.awt.Dimension(10, 8));
        jLabel4.setPreferredSize(new java.awt.Dimension(10, 8));
        jLabel4.setSize(new java.awt.Dimension(10, 8));
    ...
    private void lblLoginMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblLoginMousePressed
        ...
        if (userAccount == null) {
            for (Network network : ecosystem.getNetworkCatalog()) {
        ...
        if (userAccount == null) {
            ...
            if (userAccount != null && userAccount.getRole() != null) {
                ...
                container.add("workArea",userAccount.getRole().createWorkArea(container, userAccount, inOrganization, inEnterprise, ecosystem, personDirectory, ngoDirectory, donorDirectory));
    ...
    private void lblAdoptMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblAdoptMousePressed
        // TODO add your handling code here:
        NGORegistrationJPanel panel = new NGORegistrationJPanel(container, ecosystem);
        loginJPanel.setVisible(false);
        container.setVisible(true);
        UpperPanel.setVisible(true);
    ...
    private void lblSponsorMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblSponsorMousePressed
        // TODO add your handling code here:
        SponsorRegistrationJPanel panel = new SponsorRegistrationJPanel(container, ecosystem);
        loginJPanel.setVisible(false);
        container.setVisible(true);
        UpperPanel.setVisible(true);
        btnLogoutLabel.setVisible(false);
