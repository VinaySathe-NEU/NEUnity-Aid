 ...
 * @author vinaysathe
 */
public class SponsorTaskArea extends javax.swing.JPanel {
    ...
    public SponsorTaskArea(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise, Ecosystem business, NGODirectory ngoDirectory, PersonDirectory personDirectory, DonorDirectory donorDirectory) {
        initComponents();
    ...
    private void manageDonorWorkAreaJPanel() {
        SponsorRequestTable panel = new SponsorRequestTable(rightSystemAdminPanel, account, donororganization, enterprise, business, ngoDirectory, personDirectory, donorDirectory);
    ...
    private void TrackStatus() {
        StatusSponsor panel = new StatusSponsor(rightSystemAdminPanel, account, donororganization, enterprise, business, ngoDirectory, personDirectory, donorDirectory);
    ...
    private void initComponents() {
        ...
        manageNetworkPanel.setBackground(new java.awt.Color(158, 228, 147));
        ...
        DonorWorkArea.setText("Sponsor Task Area");
        ...
        lblViewYourStatus.setBackground(new java.awt.Color(158, 228, 147));
