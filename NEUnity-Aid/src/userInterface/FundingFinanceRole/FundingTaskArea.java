 ...
 * @author RakshitaJ
 */
public class FundingTaskArea extends javax.swing.JPanel {
    ...
    public FundingTaskArea(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise, Ecosystem business, PersonDirectory personDirectory) {
        initComponents();
    ...
    private void manageFinance(){
        FinanceTaskAreaJPanel panel = new FinanceTaskAreaJPanel(rightSystemAdminPanel, account, financeOrphanageOrganization, enterprise, business, personDirectory);
    ...
    private void TrackStatus(){
        ViewAndProcessTransactionRecord panel = new ViewAndProcessTransactionRecord(rightSystemAdminPanel, account, financeOrphanageOrganization, enterprise, business, personDirectory);
