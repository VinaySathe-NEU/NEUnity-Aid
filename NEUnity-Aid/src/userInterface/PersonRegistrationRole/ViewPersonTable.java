       ...
       int selectedRow = tblNewPerson.getSelectedRow();
        ...
        if (result == 0) {
                ...
                for (Enterprise ent : network.getEnterpriseDirectory().getEnterpriseList()) {
                    if (this.network.equals(network)) {
                        for (Organization organization : ent.getOrganizationDirectory().getOrganizationList()) {
                            if (organization instanceof MedicalOrganization || organization instanceof PharmacistOrganization || organization instanceof LabOrganization) {
            ...
            for (Organization org : list) {
                org.getTaskQueue().delete(ch.getPersonID());
            }
            account.getTaskQueue().delete(ch.getPersonID());
            business.getTaskQueue().delete(ch.getPersonID());
        }
        populateTable();
