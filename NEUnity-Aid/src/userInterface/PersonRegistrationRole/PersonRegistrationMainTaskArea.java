 ...
 * @author vinaysathe
 */
public class PersonRegistrationMainTaskArea extends javax.swing.JPanel {
    ...
    Ecosystem business;
    Network network;
    public PersonRegistrationMainTaskArea(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise, Ecosystem business, PersonDirectory persondirectory) {
        initComponents();
    ...
    private void initComponents() {
        ...
        LabNetworkPanel.setBackground(new java.awt.Color(134, 187, 216));
