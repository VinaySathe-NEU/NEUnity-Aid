 ...
 * @author RakshitaJ
 */
public class MedicTaskArea extends javax.swing.JPanel {
    ...
    public MedicTaskArea(JPanel userProcessContainer, UserAccount account, MedicalOrganization medicorganization, Enterprise enterprise ,Ecosystem ecosystem, PersonDirectory personDirectory) {
        initComponents();
        this.userProcessContainer=userProcessContainer;   
        this.userAccount = account;
        this.enterprise = enterprise;
        this.ecosystem=ecosystem;
        this.medicorganization = (MedicalOrganization)medicorganization;
        this.enterprise = enterprise;
    ...
    private void initComponents() {
        ...
        manageNetworkPanel.setBackground(new java.awt.Color(47, 72, 88));
