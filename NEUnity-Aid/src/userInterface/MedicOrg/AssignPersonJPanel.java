...
import Business.TaskQueue.PharmacistAssistTaskRequest;
...
public class AssignPersonJPanel extends javax.swing.JPanel {
    ...
    private MedicalOrganization medicorganization;
    private Ecosystem business;
    MedicalAssistanceTaskRequest request;
    ...
    Network network;
    public AssignPersonJPanel(JPanel userProcessContainer, MedicalAssistanceTaskRequest request, Person person, UserAccount userAccount, MedicalOrganization medicorganization, Enterprise enterprise, Ecosystem business, PersonDirectory personDirectory) {
        initComponents();
    ...
    public void populateLabTable() {
        ...
        model.setRowCount(0);
        for (TaskRequest labrequest : userAccount.getTaskQueue().getTaskRequestList()) {
            if (labrequest instanceof MedicalAssistanceTaskRequest || labrequest instanceof LabAssistanceTaskRequest) {
                if (labrequest.getPersonID() == person.getPersonID()) {
                    ...
                    if (labrequest instanceof MedicalAssistanceTaskRequest) {
                        String result = ((MedicalAssistanceTaskRequest) labrequest).getTestResult();
                        row[5] = result == null ? "Waiting" : result;
                    } else if (labrequest instanceof LabAssistanceTaskRequest) {
                        String result = ((LabAssistanceTaskRequest) labrequest).getResult();
                        row[5] = result == null ? "Waiting" : result;
                    }
                    model.addRow(row);
                }
    ...
    public void populateMedicationTable() {
        ...
        model.setRowCount(0);
        for (TaskRequest pharrequest : userAccount.getTaskQueue().getTaskRequestList()) {
            if (pharrequest instanceof MedicalAssistanceTaskRequest || pharrequest instanceof PharmacistAssistTaskRequest) {
                if (pharrequest.getPersonID() == person.getPersonID()) {
                    ...
                    if (pharrequest instanceof MedicalAssistanceTaskRequest) {
                        String result = ((MedicalAssistanceTaskRequest) pharrequest).getTestResult();
                        row[4] = result == null ? "Prescribed Medicine" : result;
                    } else if (pharrequest instanceof PharmacistAssistTaskRequest) {
                        String result = ((PharmacistAssistTaskRequest) pharrequest).getResult();
                        row[4] = result == null ? "Waiting" : result;
                    }
                    if (pharrequest instanceof MedicalAssistanceTaskRequest) {
                        String medicalPrescription = ((MedicalAssistanceTaskRequest) pharrequest).getPrescription();
                        row[5] = medicalPrescription == null ? "" : medicalPrescription;
                    } else if (pharrequest instanceof PharmacistAssistTaskRequest) {
                        String medicalPrescription = ((PharmacistAssistTaskRequest) pharrequest).getPrescription();
                        row[5] = medicalPrescription == null ? "" : medicalPrescription;
                    }
                    model.addRow(row);
                }
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        person.setBloodPressure(BP);
        person.setBodyTemperature(temperature);
    ...
    private void getPersonDetails() {
        ...
        txtTemp.setText(String.valueOf(person.getBodyTemperature()));
        txtPulse.setText(String.valueOf(person.getPulseRate()));
        txtBP.setText(String.valueOf(person.getBloodPressure()));
        txtRR.setText(String.valueOf(person.getRespirationRate()));
        if (person.getBodyTemperature() == 0.0 || person.getBloodPressure() == 0.0 || person.getPulseRate() == 0.0 || person.getRespirationRate() == 0.0) {
