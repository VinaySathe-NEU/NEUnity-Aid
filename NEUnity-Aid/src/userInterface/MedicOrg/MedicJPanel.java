...
public class MedicJPanel extends javax.swing.JPanel {
    ...
    public MedicJPanel(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise, Ecosystem business, PersonDirectory personDirectory) {
        ...
        this.medicorganization = (MedicalOrganization) organization;
     ...
     public void populateRequestTable() {
        ...
        model.setRowCount(0);
        for (TaskRequest request : medicorganization.getTaskQueue().getTaskRequestList()) {
            business.getTaskQueue().getTaskRequestList();
            if (request instanceof MedicalAssistanceTaskRequest) {
                ...
                row[4] = request.getSender().getEmployee().getEmployeeID();
...
//                row[6] = result == null ? "Waiting" : result;
    ...
    private void btnAssignToMeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAssignToMeActionPerformed
        ...
        MedicalAssistanceTaskRequest request = (MedicalAssistanceTaskRequest) tblMedic.getValueAt(selectedRow, 0);
    ...
    private void btnProcessActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProcessActionPerformed
        ...
        for (Person p : personDirectory.getPersonList()) {
            if (p.getPersonID() == request.getPersonID()) {
                person = p;
            }
        }
