...
import Business.Person.PersonDirectory;
import userInterface.PersonCare.*;

/**
 *
 * @author vinaysathe
 */
public class PersonCareTaskArea extends javax.swing.JPanel {
    ...
    public PersonCareTaskArea(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise, Ecosystem business, PersonDirectory personDirectory, NGODirectory ngoDirectory) {
        initComponents();
    ...
    private void initComponents() {
        ...
        LeftPanel.setBackground(new java.awt.Color(218, 247, 220));
        ...
        ChildWorkArea.setBackground(new java.awt.Color(218, 247, 220));
        ...
        lblViewChild.setBackground(new java.awt.Color(218, 247, 220));
        ...
        AdoptionPanel.setBackground(new java.awt.Color(218, 247, 220));
    ...
    private void managePersonAreaJPanel() {
        AcquirePerson panel = new AcquirePerson(rightSystemAdminPanel, account, personCareOrganization, enterprise, business, personDirectory, ngoDirectory);
    ...
    private void ViewPerson() {
        ViewPersonDetails panel = new ViewPersonDetails(rightSystemAdminPanel, account, personCareOrganization, enterprise, business, personDirectory, ngoDirectory);
        rightSystemAdminPanel.add("ManageNetworkJPanel", panel);
        CardLayout layout = (CardLayout) rightSystemAdminPanel.getLayout();
        layout.next(rightSystemAdminPanel);
    }
    ...
    private void ViewAdopterRequest() {
        ViewNGORequest panel = new ViewNGORequest(rightSystemAdminPanel, account, personCareOrganization, enterprise, business, personDirectory, ngoDirectory);
        rightSystemAdminPanel.add("ManageNetworkJPanel", panel);
        CardLayout layout = (CardLayout) rightSystemAdminPanel.getLayout();
        layout.next(rightSystemAdminPanel);
    }
