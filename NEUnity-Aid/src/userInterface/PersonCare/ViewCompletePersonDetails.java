...
public class ViewCompletePersonDetails extends javax.swing.JPanel {
    ...
    public ViewCompletePersonDetails(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise, Ecosystem business, PersonDirectory personDirectory, Person person, boolean flag) {
        ...
        nameTextField.setText(person.getPersonName());
        ...
        bpText.setText(String.valueOf(person.getBloodPressure()));
        pulseText.setText(String.valueOf(person.getPulseRate()));
        tempText.setText(String.valueOf(person.getBodyTemperature()));
        ...
        btnRequestFunds.setEnabled(!person.isFinancialAid() && flag);
        requestMedicalHelpBtn.setEnabled(!person.isRequireMedicalHelp());
    }
    ...
    public void populaterequestTable() {
        ...
        dtms.setRowCount(0);
        for (TaskRequest request : account.getTaskQueue().getTaskRequestList()) {
            if (request.getPersonID() == person.getPersonID()) {
                ...
                if (request instanceof MedicalAssistanceTaskRequest) {
                    String result = ((MedicalAssistanceTaskRequest) request).getTestResult();
                    String remarks = ((MedicalAssistanceTaskRequest) request).getRemark();
                    row[5] = remarks;
                    row[4] = result == null ? "Waiting" : result;
                }
                if (request instanceof EducationAssistTaskRequest) {
                    row[4] = request.getStatus();
                    row[5] = ((EducationAssistTaskRequest) request).getRemarks();
                }
                dtms.addRow(row);
            }
        }
