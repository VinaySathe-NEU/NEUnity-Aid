...
public class FinanceCheckRequestJPanel extends javax.swing.JPanel {
    ...
    public FinanceCheckRequestJPanel(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise, Ecosystem business, NGODirectory ngoDirectory) {
        initComponents();
...
// Assign Action Button
    ...
    private void btnAssignActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAssignActionPerformed
        ...
        if (receiverval == null) {
            ...
            request.setStatus("Finance organization processing");
    ...
    private void btnProcessActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProcessActionPerformed
        ...
        if (receiverval == null) {
            ...
            if (receiverval.equals(account.getUsername()) && statusval.equals("Finance organization processing")) {
                ...
                FinanceCheckProcess panel = new FinanceCheckProcess(userProcessContainer, account, financeOrganization, enterprise, business, ngoDirectory, (FinanceCheckProcessTaskRequest) request, ngo);
