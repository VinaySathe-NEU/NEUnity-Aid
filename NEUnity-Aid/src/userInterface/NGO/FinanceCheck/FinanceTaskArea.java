 ...
 * @author RakshitaJ
 */
public class FinanceTaskArea extends javax.swing.JPanel {
    ...
    public FinanceTaskArea(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise, Ecosystem business, NGODirectory ngoDirectory) {
        initComponents();
    ...
    private void financeRequestJPanel(){
        FinanceCheckRequestJPanel panel = new FinanceCheckRequestJPanel(rightSystemAdminPanel, account, financeOrganization, enterprise, business, ngoDirectory);
    ...
    private void initComponents() {
        ...
        FinanceRequest.setBackground(new java.awt.Color(134, 187, 216));
