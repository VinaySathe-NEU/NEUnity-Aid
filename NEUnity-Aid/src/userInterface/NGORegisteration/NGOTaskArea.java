 ...
 * @author RakshitaJ
 */
public class NGOTaskArea extends javax.swing.JPanel {
    ...
    public NGOTaskArea(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise, Ecosystem business, NGODirectory ngoDirectory, PersonDirectory personDirectory) {
        initComponents();
    ...
    private void goToCheckStatusJPanel() {
        CheckStatusJPanel panel = new CheckStatusJPanel(rightSystemAdminPanel, account, ngoOrganization, enterprise, business, ngoDirectory, ngo.getUserID(), personDirectory);
    ...
    private void initComponents() {
        ...
        Adopter.setBackground(new java.awt.Color(134, 187, 216));
