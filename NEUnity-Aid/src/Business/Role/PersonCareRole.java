...
import userInterface.PersonCare.PersonCareTaskArea;
...
public class PersonCareRole extends Role {
    ...
    public String toString() {
        return (RoleType.PersonCare.getRoleValue());
    }
    ...
    public JPanel createWorkArea(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise, Ecosystem ecosystem, PersonDirectory personDirectory, NGODirectory ngoDirectory,DonorDirectory donorDirectory) {
        return new PersonCareTaskArea(userProcessContainer, account, organization, enterprise, ecosystem, personDirectory, ngoDirectory);
    }
