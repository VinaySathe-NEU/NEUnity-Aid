...
import userInterface.FundingFinanceRole.FundingTaskArea;
...
public class FundingFinanceRole extends Role{
    ...
    public String toString(){
        return (RoleType.Finance.getRoleValue());
    }
    ...
    public JPanel createWorkArea(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise, Ecosystem ecosystem, PersonDirectory personDirectory, NGODirectory ngoDirectory, DonorDirectory donorDirectory) {
        return new FundingTaskArea(userProcessContainer, account, organization, enterprise, ecosystem, personDirectory);
    }
}
